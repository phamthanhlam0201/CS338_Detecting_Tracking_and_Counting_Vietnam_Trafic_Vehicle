...
def draw_boxes(img, bbox, clss, identities=None, offset=(0, 0)):
            ...
            while cap.isOpened():
                ...
                for r in results:
                    ...
                    for box in boxes:
                        ...
                        if currentclass in ['car', 'bus', 'truck', 'motor'] and conf > 0.6:
                ...
                for results in resultracker:
                    x1, y1, x2, y2, id, cls = results
                    x1, y1, x2, y2 = int(x1), int(y1), int(x2), int(y2)
                    bboxes.append([x1, y1, x2, y2])
                    identities.append(id)
                    clss.append(int(cls))

                draw_boxes(img, bboxes, clss, identities)
